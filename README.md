...
- **analysis/** 
    - **output/** 
        ...
        - **EMPE_data_formatted.RData** [formatted data for analysis, after cleaning. Is generated by `script1_PrepareData.R`]
        - **fitted_model.RData** [Bayesian output in JAGS. Is generated by `script2_FitModel.R`]
    - `script1_PrepareData.R` [R script to visualize, clean, and package raw data for analysis with JAGS]
    - `script2_FitModel.R` [R script to fit Bayesian model, check convergence, evaluate goodness of fit, and generate results, figures, and summary statistics]
